...
--      The slot-fill pools. `ner.data.pools.load_from_postgres` reads these
--      tables; the seed is generated by `scripts.build_seed` into
--      sql/postgres/seed.sql and loaded via `scripts.init_postgres`.
--
